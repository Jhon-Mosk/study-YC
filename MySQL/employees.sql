...
SELECT
    'LOADING departments' AS 'INFO';

source load_departments.dump;

SELECT
    'LOADING employees' AS 'INFO';

source load_employees.dump;

SELECT
    'LOADING dept_emp' AS 'INFO';

source load_dept_emp.dump;

SELECT
    'LOADING dept_manager' AS 'INFO';

source load_dept_manager.dump;

SELECT
    'LOADING titles' AS 'INFO';

source load_titles.dump;

SELECT
    'LOADING salaries' AS 'INFO';
