user@DESKTOP-D761754:/mnt/f/Project/ShmakovSMM/studyYC$ echo "export ENDPOINT=https://docapi.serverless.yandexcloud.net/ru-central1/b1ghk9uitis1fanhbci6/etn0s60acnb01kg3t91e" >> ~/.bashrc && . ~/.bashrc
user@DESKTOP-D761754:/mnt/f/Project/ShmakovSMM/studyYC$ curl \
-Amz-T>   -H 'X-Amz-Target: DynamoDB_20120810.CreateTable' \
...
user@DESKTOP-D761754:/mnt/f/Project/ShmakovSMM/studyYC$ curl \
-Amz-T>   -H 'X-Amz-Target: DynamoDB_20120810.PutItem' \
-H "A>   -H "Authorization: Bearer $(yc iam create-token)" \
 "Con>   -H "Content-Type: application.json" \
...
uthoriza>   -H "Authorization: Bearer $(yc iam create-token)" \
 "Con>   -H "Content-Type: application.json" \
...
user@DESKTOP-D761754:/mnt/f/Project/ShmakovSMM/studyYC$ curl \
 -H 'X>   -H 'X-Amz-Target: DynamoDB_20120810.DeleteTable' \
>   -H "Authorization: Bearer $(yc iam create-token)" \
>   -H "Content-Type: application.json" \
d '{"T>   -d '{"TableName": "docapitest/series"}' \
>   $ENDPOINT
...
user@DESKTOP-D761754:/mnt/f/Project/ShmakovSMM/studyYC$ pip install awscli
Collecting awscli
...
user@DESKTOP-D761754:/mnt/f/Project/ShmakovSMM/studyYC$ aws configure
AWS Access Key ID [None]: YCAJEOAUnHwKD-hDIBPr8EBGA
AWS Secret Access Key [None]: YCMgsMdSodCqbd2VCUYF4pFGRNbFPLEwJrVCgOav
Default region name [None]: ru-central1
Default output format [None]: 

aws dynamodb create-table \
table-na>   --table-name docapitest/series \
...
user@DESKTOP-D761754:/mnt/f/Project/ShmakovSMM/studyYC$ aws dynamodb put-item \
  --tabl>   --table-name docapitest/series \
...
user@DESKTOP-D761754:/mnt/f/Project/ShmakovSMM/studyYC$ aws dynamodb get-item --consistent-read \
...
user@DESKTOP-D761754:/mnt/f/Project/ShmakovSMM/studyYC$ aws dynamodb query \
>   --table-name docapitest/series \
--key-co>   --key-condition-expression "series_id = :name" \
...
user@DESKTOP-D761754:/mnt/f/Project/ShmakovSMM/studyYC$ aws dynamodb delete-table \
>   --table-name docapitest/series \
>   --endpoint $ENDPOINT
{
    "TableDescription": {
...
user@DESKTOP-D761754:/mnt/f/Project/ShmakovSMM/studyYC$ pip install boto3
Collecting boto3
...
user@DESKTOP-D761754:/mnt/f/Project/ShmakovSMM/studyYC/serveless/YDB$ python3 SeriesCreateTable.py
Table status: ACTIVE
user@DESKTOP-D761754:/mnt/f/Project/ShmakovSMM/studyYC/serveless/YDB$ python3 SeriesLoadData.py
...
user@DESKTOP-D761754:/mnt/f/Project/ShmakovSMM/studyYC/serveless/YDB$ python3 SeriesItemPut.py 
...
{'ResponseMetadata': {'RequestId': 'fcc36e75-bda6-4cfa-ae1a-1484e5b94582',
                      ...
                      'HTTPHeaders': {'content-security-policy': 'default-src '
                                      ...
                                      'content-length': '2'},
                      'RetryAttempts': 0}}
user@DESKTOP-D761754:/mnt/f/Project/ShmakovSMM/studyYC/serveless/YDB$ python3 SeriesItemGet.py 
Record read:
{'info': {'release_date': '2015-09-13',
 ...
 'series_id': Decimal('3'),
 'title': 'Supernatural'}
user@DESKTOP-D761754:/mnt/f/Project/ShmakovSMM/studyYC/serveless/YDB$ python3 SeriesItemUpdate.py 
Series updated:
{'Attributes': {'info': {'rating': Decimal('8'),
 ...
 'ResponseMetadata': {'RequestId': '39e02131-3a9b-46dc-a64c-a3dcdcfa43e8',
                      ...
                      'HTTPHeaders': {'content-security-policy': 'default-src '
                                      ...
                                      'content-length': '175'},
                      'RetryAttempts': 0}}
user@DESKTOP-D761754:/mnt/f/Project/ShmakovSMM/studyYC/serveless/YDB$ python3 SeriesItemDelete.py 
Deleting...
Series data deleted:
{'ResponseMetadata': {'RequestId': '571fdf77-50b3-4213-9095-bd86b819f6ee',
                      ...
                      'HTTPHeaders': {'content-security-policy': 'default-src '
                                      ...
                                      'content-length': '2'},
                      'RetryAttempts': 0}}
user@DESKTOP-D761754:/mnt/f/Project/ShmakovSMM/studyYC/serveless/YDB$ python3 SeriesQuery.py 
...
user@DESKTOP-D761754:/mnt/f/Project/ShmakovSMM/studyYC/serveless/YDB$ python3 SeriesTableScan.py 
...
user@DESKTOP-D761754:/mnt/f/Project/ShmakovSMM/studyYC/serveless/YDB$ python3 SeriesTableDelete.py 
Table Series deleted
user@DESKTOP-D761754:/mnt/f/Project/ShmakovSMM/studyYC/serveless/YDB$ 
